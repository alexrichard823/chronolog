...
export default async function FamilyDashboardPage({ params, searchParams }: FamilyDashboardPageProps) {
  ...
  return (
    <main className="mx-auto w-full max-w-4xl p-8">
      ...
      {errorCode === "no-member-manage-access" && <p className="mt-6 rounded border border-red-200 bg-red-50 p-4 text-sm text-red-700">Only the Owner or an Admin can manage family members.</p>}
